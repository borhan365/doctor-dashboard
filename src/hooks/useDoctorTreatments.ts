...
import { Treatment, TreatmentsResponse } from "@/types/doctorTreatments";
    ...
    queryFn: async () => {
      try {
        ...
        const response = await axios.get(
          `${ApiUrl}/doctors/treatments/get-all?${searchParams}`,
        );
        return response.data;
      } catch (error: any) {
        const errorMessage =
          error?.response?.data?.error || "Failed to fetch doctor treatments";
  ...
  return useMutation({
    mutationFn: async (data: FormData) => {
      const response = await axios.post(
        `${ApiUrl}/doctors/treatments/create`,
        data,
      );
      return response.data;
    },
  ...
  return useMutation({
    mutationFn: async (data: FormData) => {
      const response = await axios.patch(
        `${ApiUrl}/doctors/treatments/update/${id}`,
        data,
      );
      return response.data;
    },
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      const response = await axios.delete(
        `${ApiUrl}/doctors/treatments/single-delete/${id}`,
      );
      return response.data;
    },
    onSuccess: () => {
...
export const useTreatment = (id: string) => {
  return useQuery<{ status: string; data: Treatment }>({
    ...
    queryFn: async () => {
      const response = await axios.get(
        `${ApiUrl}/doctors/treatments/get-single/${id}`,
      );
      return response.data;
    },
    enabled: !!id,
