...
function DegreeSection({ selectedDegrees = [], onChange }: DegreeSectionProps) {
  ...
  const renderDegreeList = (
    ...
    <div className="grid max-h-[200px] grid-cols-1 gap-3 overflow-y-auto md:grid-cols-2 lg:grid-cols-3">
      {degrees.map((degree) => (
        <div
          key={degree.id}
          ...
          {editingId === degree.id ? (
            ...
            <div className="flex items-center">
              <Checkbox
                ...
                onChange={(e) =>
                  handleToggleSelect(degree.id, e.target.checked)
                }
              >
              ...
              {data?.degrees
                ...
                .map((degree) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() => handleToggleSelect(degree.id, false)}
