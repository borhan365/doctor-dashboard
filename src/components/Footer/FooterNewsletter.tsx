...
const isDisabled = (loading: boolean, retryAfter: number | null): boolean => {
  if (!retryAfter) return loading;
  return loading || Date.now() < retryAfter;
};
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div className="flex flex-col space-y-3">
          <input
            ...
            disabled={isDisabled(loading, retryAfter)}
          />
          <button
            type="submit"
            disabled={isDisabled(loading, retryAfter)}
