...
export const metadata: Metadata = {
  title: "Healtha For Doctors",
  description: "Healtha For Doctors",
};
          ...
          <div className="relative z-10 flex flex-col items-center justify-center gap-12">
            <div className="flex flex-col items-center justify-center gap-4 text-center">
              <span className="inline-flex items-center rounded-full bg-blue-50 px-3 py-1 text-sm font-medium text-blue-600 ring-1 ring-inset ring-blue-600/20 dark:bg-blue-500/10 dark:text-blue-400 dark:ring-blue-400/20">
                Complete Digital Solutions for Doctors
              </span>
              <h1 className="text-4xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-5xl lg:text-6xl !leading-[70px] pb-4">
                ...
                <span className="block bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent dark:from-blue-400 dark:to-blue-200">
                  Start Going Digitally Today
                </span>
              </h1>
              <p className="max-w-xl text-center text-lg text-slate-600 dark:text-slate-300">
                Join thousands of doctors who are revolutionizing healthcare
                delivery through our comprehensive digital platform. Expand your
                reach, streamline your practice, and enhance patient care.
              </p>
            </div>
