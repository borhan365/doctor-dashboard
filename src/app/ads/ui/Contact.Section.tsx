...
const packages = [
  {
    value: "premium",
    label: "Premium Package: 12,000 BDT/Year (Top Position)",
  },
  {
    value: "standard",
    label: "Standard Package: 9,000 BDT/Year (Featured Position)",
  },
  { value: "basic", label: "Basic Package: 6,000 BDT/Year (Regular Position)" },
];

const specialties = [
  { value: "medicine", label: "Medicine Specialist" },
  { value: "cardiology", label: "Cardiologist" },
  { value: "dermatology", label: "Dermatologist" },
  { value: "neurology", label: "Neurologist" },
  { value: "gynecology", label: "Gynecologist & Obstetrician" },
  { value: "pediatrics", label: "Pediatrician" },
  { value: "orthopedics", label: "Orthopedic Surgeon" },
  { value: "ent", label: "ENT Specialist" },
  { value: "dental", label: "Dental Surgeon" },
  { value: "eye", label: "Eye Specialist" },
