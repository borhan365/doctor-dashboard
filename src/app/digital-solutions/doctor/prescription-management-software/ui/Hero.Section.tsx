...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 to-white py-16 dark:from-slate-950 dark:to-slate-900 lg:py-20">
      ...
      <div className="container relative mx-auto max-w-7xl px-4">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="mb-6 text-4xl font-bold !leading-[70px] tracking-tight text-slate-900 dark:text-white lg:text-5xl xl:text-6xl">
            #1 Prescription Management Software{" "}
            <span className="relative">
              <span className="relative z-10 text-blue-600 dark:text-blue-400">
                The Best Medical Practice Solution
              </span>
          ...
          <p className="mb-8 max-w-3xl text-lg text-slate-600 dark:text-slate-400">
            Our prescription management software ensures streamlined operations,
            modern e-prescribing, patient management, inventory tracking, and
            practice growth. Experience efficient digital prescribing with our
            comprehensive medical billing integration.
          </p>
          ...
          <div className="relative w-full max-w-5xl">
            ...
            <div className="relative rounded-2xl bg-white p-2 shadow-2xl dark:bg-slate-900">
              <div className="aspect-[16/9] overflow-hidden rounded-xl bg-slate-100 dark:bg-slate-800">
                <Image
                  src="https://www.bdtask.com/sp/pharmacy-management-system/img/image/pharmacy-management-system.webp"
                  alt="Prescription Management Software Dashboard"
                  width={1200}
                  height={800}
