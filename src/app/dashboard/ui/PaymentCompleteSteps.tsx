...
interface PaymentCompleteStepsProps {
  doctorProfile?: Doctor | null;
}

function PaymentCompleteSteps({
  doctorProfile: initialProfile,
}: PaymentCompleteStepsProps) {
    ...
    <div className="mb-6 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition-colors dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="grid gap-6 p-6 lg:grid-cols-2">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-blue-100 bg-gradient-to-br from-blue-50 to-blue-50/30 p-6 dark:border-blue-900/50 dark:from-blue-900/20 dark:to-blue-900/10">
            ...
            <button className="mt-2 w-full rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:hover:bg-blue-600">
              Pay Now
            </button>
          </div>
      ...
      <div className="border-t border-slate-200 bg-slate-50 px-6 py-4 dark:border-slate-800 dark:bg-slate-800/50">
        <p className="text-center text-sm text-slate-600 dark:text-slate-400">
          Join our network of verified doctors and expand your practice reach
          across Bangladesh
        </p>
      </div>
    </div>
...
export default PaymentCompleteSteps;
